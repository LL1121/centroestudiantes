...
export function UploadFormInstitutional() {
      ...
      <div className="rounded-xl border border-border bg-secondary/20">
        ...
        {apaOpen && (
          <div className="space-y-4 border-t border-border px-4 py-4">
            ...
            <Field label="Autor" value={autor} onChange={setAutor} disabled={pending} placeholder="Apellido, N." />
            <Field label="Año de publicación" value={anio} onChange={setAnio} disabled={pending} placeholder="2024" />
            <Field label="Editorial" value={editorial} onChange={setEditorial} disabled={pending} placeholder="Editorial Ejemplo" />
            <Field label="Ciudad de publicación" value={ciudad} onChange={setCiudad} disabled={pending} placeholder="Buenos Aires" />
            <Field label="ISBN" value={isbn} onChange={setIsbn} disabled={pending} placeholder="978-..." />
          </div>
        )}
      </div>
